...
public class MGDateTimePicker extends Dialog{
    ...
    public MGDateTimePicker(Context context, Date startDate, DateType dateType, MyListener myListener) {
        super(context,  R.style.mg_date_time_picker);
    ...
    public void setContentAndShow(){
        setContentView(R.layout.mg_dialog_date_time_picker);
        ...
        Button ok = findViewById(R.id.date_selected);
